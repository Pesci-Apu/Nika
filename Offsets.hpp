    ...
    constexpr long OFFSET_IN_FORWARD = 0x074dbf70; //[Buttons]->in_forward
    ...
    constexpr long OFF_VIEW_RENDER = 0x74DADA8; //[RecvTable.DT_Player]->ViewRender
    ...
    constexpr long OFF_GLOW_HIGHLIGHTS = 0xADE39C0; //
