...
constexpr long OFFSET_IN_FORWARD = 0x0769a428; //[Buttons]->in_forward
...
constexpr long OFF_LAST_VISIBLE_TIME = 0x199e; //[RecvTable.DT_BaseCombatCharacter]->CPlayer!lastVisibleTime // m_hudInfo_visibilityTestAlwaysPasses + 0x2
constexpr long OFF_LAST_AIMEDAT_TIME = 0x199e + 0x8; //[RecvTable.DT_BaseCombatCharacter]->CPlayer!lastVisibleTime + 0x8 // m_hudInfo_visibilityTestAlwaysPasses + 0x2 + 0x8
...
constexpr long OFF_CAMERAORIGIN = 0x1ee0; //[Miscellaneous]->CPlayer!camera_origin// Game Version: v.3.0.76.22
#pragma once
constexpr long OFF_REGION = 0x140000000; //[Static]->Region
constexpr long OFF_LEVEL = 0x17eb494; //[Miscellaneous]->LevelName
constexpr long OFF_LOCAL_PLAYER = 0x23e7ff8; //[Miscellaneous]->LocalPlayer
...
constexpr long OFF_GLOW_HIGHLIGHTS = 0xb13b520; // - 6C1B0
