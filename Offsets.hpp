...
constexpr long OFF_LAST_AIMEDAT_TIME = 0x19a8; //[RecvTable.DT_BaseCombatCharacter]->CPlayer!lastVisibleTime + 0x8 // m_hudInfo_visibilityTestAlwaysPasses + 0x2 + 0x8
constexpr long OFF_VIEW_ANGLES = 0x2530; //[DataMap.C_Player]->m_ammoPoolCapacity - 0x14
constexpr long OFF_PUNCH_ANGLES = 0x2448; //[DataMap.C_Player]->m_currentFrameLocalPlayer.m_vecPunchWeapon_Angle
constexpr long OFF_BREATH_ANGLES = 0x2520; //(OFF_VIEW_ANGLES - 0x10)
constexpr long OFF_STUDIOHDR = 0x1000; //[Miscellaneous]->CBaseAnimating!m_pStudioHdr
constexpr long OFF_BONES = 0x0df8; //[RecvTable.DT_BaseAnimating]->m_nForceBone + 0x48
...
constexpr long OFF_YAW = 0x2244; //[DataMap.C_Player]=>m_currentFramePlayer.m_ammoPoolCount - 0x8
